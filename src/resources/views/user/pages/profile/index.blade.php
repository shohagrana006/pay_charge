        ...
        <div class="row ">
            ...
            <div class="col-12 col-md-12 col-lg-9 col-xl-10 col-xxl-10">
                <div class="d-flex align-items-center">
                    <h4 class="text-secondary m-0">{{ ucfirst($user->name) }}</h4>
                </div>             
            </div>
        </div>
    </div>
                                ...
                                <div class="p-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-3 mb-3">
                                            <label class="form-label">{{ decode('Email') }}</label>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="text" name="name" value="{{ $user->name }}" class="form-control @error('name') is-invalid @enderror" id="validationCustom01" required="">
                                        ...
                                        <div class="p-2">
                                            <div class="row">
                                                <div class="col-md-12 mt-3 mb-2">
                                                    ...
                                                    <input type="file" name="profile_image" class="form-control @error('profile_image') is-invalid @enderror" id="user_photo">
                                                    <div class="ms-3 text-danger">
                                                        @error('profile_image') {{ $message }} @enderror
                                                    </div>
                                                    <div class="admin-image-preview" id="user-image-preview">
                                                        <img alt=''class='mt-2  img-thumbnail me-2 '
                                                        src="{{displayImage('assets/images/user/profile/'.$user->profile_image, App\Cp\ImageProcessor::filePath()['user_profile']['size'])}}" >
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        (function($) {
            ...
            $(document).on('change', '#user_photo', function(e) {
                emptyInputFiled('user-image-preview')
                let file = e.target.files[0];
                imagePreview(file, 'user-image-preview','user-image-preview');
                e.preventDefault();
            })
            /* ==============================
