...
@section('admin_main_content')
    ...
    <div>
        ...
        <form action="{{ route('admin.seoSetting.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="rounded_box mt-3">
                <div class="mb-2">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h5> {{ decode('Create Frontend Seo') }} </h5>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea  class="form-control" name="meta_description[{{$language->code}}]" id="" cols="30" rows="10">
                                        {{ old('meta_description.'.$language->code) }}
                                    </textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-6 mt-3">
                <button class="btn btn--primary" type="submit">{{ decode('Add') }}</button>
            </div>
        </form>
