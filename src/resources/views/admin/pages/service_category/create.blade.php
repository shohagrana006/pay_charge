...
@section('admin_main_content')
    ...
    <section>
        ...
        <div class="mb-2">
            <h5 class="m-0" id="">{{decode('Create Service Category')}}</h5>
        </div>
        <!-- form section start  -->
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-3">
                                    ...
                                    <div class="input-container position-relative ps-5">
                                        ...
                                        <input placeholder="Enter Service Category Name" type="text" name="name[{{$language->code}}]" value="{{ old('name.'.$language->code) }}" class="form-control  border-0 rounded-0" id="validationCustom01">
                                    </div>
                                    @if(session()->get('locale') == $language->code)
