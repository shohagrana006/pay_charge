    ...
    <section>
        ...
        <div class="white-auto-fill">
            <div class="section-container rounded py-3">
                <h5>{{ decode('FAQ Create') }}</h5>
            </div>
            <form action="{{route('admin.faq.store')}}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation label_margin_top">
                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="input-container position-relative ps-5">
                                            ...
                                            <input placeholder="Write Question Name" type="text" name="qsn[{{$language->code}}]" value="{{ old('qsn.'.$language->code) }}" class="form-control  border-0 rounded-0" id="validationCustom01">
                                        </div>
                                        @if(session()->get('locale') == $language->code)
