...
@section('admin_main_content')
    ...
    <section>
        ...
        <div class="white-auto-fill">
            <form action="{{route('admin.choose.update')}}" method="POST" enctype="multipart/form-data" class="needs-validation label_margin_top" novalidate="">
                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="input-container position-relative ps-5">
                                            ...
                                            <input placeholder="Enter Heading" type="text" name="qsn[{{$language->code}}]" value="{{ $choose->getTranslation('qsn', $language->code) }}" class="form-control  border-0 rounded-0" id="validationCustom01">
                                        </div>
                                        @if(session()->get('locale') == $language->code)
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div class="input-container position-relative ps-5">
                                            ...
                                            id="floatingInput"
                                            placeholder=""
                                            value="{{ $choose->getTranslation('ans', $language->code) }}"
                                            />
                                        </div>
                                        <div class=" text-danger">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-3">
                                    ...
                                    <div class="input-container position-relative ps-5">
                                        ...
                                        <input type="text" value="{{$choose->icon}}" name="icon" class="form-control  border-0 rounded-0">
                                     </div>                                  
                                </div>
                            </div>
                        </div>
